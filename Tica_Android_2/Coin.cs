...
namespace Tica_Android_2
{
	public class Coin : Sprite
	{
		...
		public virtual void Update(Player igrac, float speed_scale, GameTime gameTime,int sirina, float brzina,ref int racun,bool mute_ON)
	...
	public class Diamond:Coin
	{
		...
		public Diamond (Texture2D tex,SoundEffect zvuk,Rectangle rect,float resize_scale)
		{
			collect_zvuk = zvuk;
			brzina_kretanja = (int)3;
			texture = tex;
		...
		public override void Update(Player igrac, float speed_scale, GameTime gameTime,int sirina, float brzina,ref int racun,bool mute_ON)
		{
			if (pokupljen) {
		...
		public void Update_tourtorial(Player igrac,bool mute_ON, float speed_scale)
		{
			if (pokupljen) {
				if (rectangle.X > -rectangle.Width)
					rectangle.X -= (int)(udaljenost_x / 19);
